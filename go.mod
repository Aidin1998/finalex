...
replace github.com/go-redis/redis/v9 => github.com/redis/go-redis/v9 v9.9.0

replace github.com/crate-crypto/go-kzg-4844 => github.com/crate-crypto/go-kzg-4844 v0.3.0
